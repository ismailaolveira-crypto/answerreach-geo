...
export async function PATCH(
	...
	const response = await fetch(
		`${API_BASE_URL}/api/v1/workspaces/${encodeURIComponent(workspaceId)}/collaboration/contexts/${encodeURIComponent(contextType)}/${encodeURIComponent(contextId)}/work-info`,
		{
			method: "PATCH",
			cache: "no-store",
